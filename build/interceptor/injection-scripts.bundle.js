...
/***/ "./src/interceptor/injection-scripts.js":
/*!**********************************************!*\
  !*** ./src/interceptor/injection-scripts.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
...
(function () {
  ...
  var BACKEND_URL = 'https://api.reclaimprotocol.org';
  var PROVIDER_API_ENDPOINT = function PROVIDER_API_ENDPOINT(providerId) {
    return "".concat(BACKEND_URL, "/api/providers/").concat(providerId, "/custom-injection");
  };
  ...
  function getProviderIdFromStorage() {
    try {
      ...
      var keyValue = 'reclaimProviderId';
      var value = localStorage.getItem(keyValue);
      if (value) {
        debug.info("Found provider ID in localStorage[".concat(keyValue, "]: ").concat(value));
        return value;
      }
   ...
   */
  function fetchProviderInjectionScript(_x) {
    return _fetchProviderInjectionScript.apply(this, arguments);
  }
  /**
   * Execute the fetched injection script safely
   */
  function _fetchProviderInjectionScript() {
    _fetchProviderInjectionScript = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(providerId) {
      var response, scriptContent, _t;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          case 0:
            _context.p = 0;
            debug.info("Fetching injection script for provider: ".concat(providerId));
            _context.n = 1;
            return fetch(PROVIDER_API_ENDPOINT(providerId), {
              method: 'GET',
              headers: {
          ...
          case 3:
            scriptContent = _context.v;
            if (!(!scriptContent || scriptContent.trim() === '')) {
              _context.n = 4;
              break;
            }
            debug.info("No injection script content found for provider: ".concat(providerId));
            return _context.a(2, null);
          case 4:
            debug.info("Successfully fetched injection script for provider: ".concat(providerId));
            return _context.a(2, {
          ...
          case 5:
            _context.p = 5;
            _t = _context.v;
            debug.error("Failed to fetch injection script for provider ".concat(providerId, ":"), _t);
            return _context.a(2, null);
        }
      }, _callee, null, [[0, 5]]);
    }));
  ...
  function executeInjectionScript(scriptContent, providerData) {
    try {
      debug.info("Executing injection script for provider: ".concat(providerData.name || 'Unknown'));
      ...
      var scriptFunction = new Function('window', 'document', 'console', 'localStorage', 'sessionStorage', 'providerData', scriptContent);
      ...
      debug.info("Successfully executed injection script for provider: ".concat(providerData.name || 'Unknown'));
   ...
   */
  function loadAndExecuteInjectionScript() {
    return _loadAndExecuteInjectionScript.apply(this, arguments);
  }
  /**
   * Initialize the injection script loader
   * Waits for DOM to be ready before executing
   */
  function _loadAndExecuteInjectionScript() {
    _loadAndExecuteInjectionScript = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
      var providerId, injectionData, _t2;
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          case 0:
            _context2.p = 0;
            // Try to get provider ID from localStorage first
            providerId = getProviderIdFromStorage(); // const providerId = "8f8f3def-7864-4dae-890d-9e95c5e45bec"
            ...
            _context2.n = 1;
            return getProviderIdFromExtension();
          case 1:
            providerId = _context2.v;
          case 2:
            if (providerId) {
              _context2.n = 3;
              break;
          ...
          case 3:
            _context2.n = 4;
            return fetchProviderInjectionScript(providerId);
          case 4:
            injectionData = _context2.v;
            if (injectionData) {
              _context2.n = 5;
              break;
            }
          ...
          case 6:
            _context2.p = 6;
            _t2 = _context2.v;
            debug.error('Error in loadAndExecuteInjectionScript:', _t2);
          case 7:
            return _context2.a(2);
        }
      }, _callee2, null, [[0, 6]]);
  ...
  window.reclaimInjectionLoader = {
    loadAndExecuteInjectionScript: loadAndExecuteInjectionScript,
    getProviderIdFromStorage: getProviderIdFromStorage,
    getProviderIdFromExtension: getProviderIdFromExtension,
    fetchProviderInjectionScript: fetchProviderInjectionScript,
    executeInjectionScript: executeInjectionScript
  };
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/interceptor/injection-scripts.js");
/******/ 	
/******/ })()
;
