...
/***/ "./src/interceptor/network-interceptor.js":
/*!************************************************!*\
  !*** ./src/interceptor/network-interceptor.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
...
(function () {
  var injectionFunction = function injectionFunction() {
    /**
    ...
    var debug = {
      ...
      // Disabled console.log("🔍 [Debug]:", ...args),
      error: function error() {
        return undefined;
      },
      // Disabled console.error("❌ [Error]:", ...args),
      info: function info() {
        return undefined;
      } // Disabled console.info("ℹ️ [Info]:", ...args),
    };
    ...
    var RequestInterceptor = /*#__PURE__*/function () {
      ...
      function RequestInterceptor() {
        ...
        this.originalFetch = (_window$fetch = window.fetch) === null || _window$fetch === void 0 ? void 0 : _window$fetch.bind(window);
      ...
      return _createClass(RequestInterceptor, [{
        key: "processRequestMiddlewares",
        value: (function () {
          var _processRequestMiddlewares = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(requestData) {
            var _t;
            return _regenerator().w(function (_context) {
              while (1) switch (_context.p = _context.n) {
                case 0:
                  _context.p = 0;
                  _context.n = 1;
                  return Promise.all(this.requestMiddlewares.map(function (middleware) {
                ...
                case 2:
                  _context.p = 2;
                  _t = _context.v;
                  debug.error("Error in request middleware:", _t);
                case 3:
                  return _context.a(2);
              }
            }, _callee, this, [[0, 2]]);
          }));
          function processRequestMiddlewares(_x) {
            return _processRequestMiddlewares.apply(this, arguments);
          }
          return processRequestMiddlewares;
        }()
        /**
        ...
        key: "processResponseMiddlewares",
        value: (function () {
          var _processResponseMiddlewares = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(response, requestData) {
            var parsedResponse, _iterator, _step, middleware, _t2, _t3;
            return _regenerator().w(function (_context2) {
              while (1) switch (_context2.p = _context2.n) {
                ...
                case 1:
                  parsedResponse = _context2.v;
                  _iterator = _createForOfIteratorHelper(this.responseMiddlewares);
                  _context2.p = 2;
                  _iterator.s();
                case 3:
                  ...
                  _context2.p = 4;
                  _context2.n = 5;
                  return middleware(parsedResponse, requestData);
                case 5:
                  _context2.n = 7;
                  break;
                case 6:
                  _context2.p = 6;
                  _t2 = _context2.v;
                  debug.error("Error in response middleware:", _t2);
                case 7:
                  _context2.n = 3;
                  break;
                case 8:
            ...
            }, _callee2, this, [[4, 6], [2, 9, 10, 11]]);
          }));
          function processResponseMiddlewares(_x2, _x3) {
            return _processResponseMiddlewares.apply(this, arguments);
          }
          return processResponseMiddlewares;
        }()
        /**
        ...
        key: "parseResponse",
        value: (function () {
          var _parseResponse = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(response) {
            var clone, responseBody, _t4;
            return _regenerator().w(function (_context3) {
              while (1) switch (_context3.p = _context3.n) {
                ...
                case 3:
                  _context3.p = 3;
                  _t4 = _context3.v;
                  debug.error("Error parsing response:", _t4);
        ...
        key: "setupInterceptor",
        value: function setupInterceptor() {
          // Setup Fetch interceptor using a Proxy
          var originalFetch = this.originalFetch;
          var self = this;

          // Create a proxy for the fetch function
          window.fetch = new Proxy(originalFetch, {
            apply: function () {
              var _apply = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(target, thisArg, argumentsList) {
                var _argumentsList, url, _argumentsList$, options, requestData, response, _t5;
                return _regenerator().w(function (_context4) {
                  while (1) switch (_context4.p = _context4.n) {
                    case 0:
                      _argumentsList = _slicedToArray(argumentsList, 2), url = _argumentsList[0], _argumentsList$ = _argumentsList[1], options = _argumentsList$ === void 0 ? {} : _argumentsList$;
                      if (url) {
                        _context4.n = 1;
                        break;
                      }
                      return _context4.a(2, Reflect.apply(target, thisArg, argumentsList));
                    case 1:
                      requestData = {
                        url: url,
                      ...
                      _context4.p = 2;
                      _context4.n = 3;
                      return Promise.all(self.requestMiddlewares.map(function (middleware) {
                        return middleware(requestData);
                      }));
                    case 3:
                      _context4.n = 5;
                    ...
                    case 4:
                      _context4.p = 4;
                      _t5 = _context4.v;
                      debug.error("Error in request middleware:", _t5);
                    case 5:
                      _context4.n = 6;
                      return Reflect.apply(target, thisArg, [requestData.url, requestData.options]);
                    case 6:
                      ...
                      self.processResponseMiddlewares(response.clone(), requestData)["catch"](function (error) {
          ...
          var requestInfoMap = new WeakMap();
          ...
          XMLHttpRequest.prototype.setRequestHeader = function (header, value) {
            var requestInfo = requestInfoMap.get(this);
          ...
          XMLHttpRequest.prototype.send = function (data) {
            ...
            if (requestInfo) {
              ...
              var runRequestMiddlewares = /*#__PURE__*/function () {
                  ...
                  return _regenerator().w(function (_context5) {
                    while (1) switch (_context5.p = _context5.n) {
                      ...
                      case 2:
                        _context5.p = 2;
                        _t6 = _context5.v;
                        debug.error("Error in request middleware:", _t6);
                      case 3:
                        return _context5.a(2);
                    }
                  }, _callee5, null, [[0, 2]]);
                }));
                return function runRequestMiddlewares() {
              ...
              this.onreadystatechange = function (event) {
                ...
                if (this.readyState === 4) {
                  var status = this.status || 500;
                  var statusText = this.statusText || "Request Failed";
                  try {
                    /**
                     ...
                     */
                    var getResponseString = function getResponseString(response) {
                    ...
                    var responseObj = new Response(getResponseString(this.response), {
                      status: status,
                      statusText: statusText,
                      headers: new Headers(Object.fromEntries((this.getAllResponseHeaders() || "").split("\r\n").filter(Boolean).map(function (line) {
                        return line.split(": ");
                      })))
                    });
                    ...
                    self.processResponseMiddlewares(responseObj, requestInfo)["catch"](function (error) {
                      return debug.error("Error in response middleware:", error);
                    });
                  } catch (error) {
              ...
              runRequestMiddlewares().then(function () {
                originalSend.call(_this, requestInfo.options.body);
              });
            } else {
        ...
        key: "addResponseMiddleware",
        value: function addResponseMiddleware(middleware) {
          if (typeof middleware === "function") {
    ...
    interceptor.addRequestMiddleware(/*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6(request) {
        var headersObj, bodyStr, urlStr, simpleRequest, fallbackUrl;
              ...
              try {
                ...
                try {
                  if (request.options.headers) {
                    ...
                    } else if (_typeof(request.options.headers) === 'object') {
                      // Only copy string values from headers
                      Object.keys(request.options.headers).forEach(function (key) {
                        var val = request.options.headers[key];
                ...
                try {
                  ...
                  } else if (request.url && _typeof(request.url) === 'object' && request.url.url) {
                    // Handle Request object
                    urlStr = request.url.url;
                  } else if (request.url && _typeof(request.url) === 'object' && request.url.href) {
                    // Handle URL object
    ...
    interceptor.addResponseMiddleware(/*#__PURE__*/function () {
      var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7(response, request) {
        var headersObj, bodyStr, urlStr, simpleResponse, fallbackUrl;
              ...
              try {
                ...
                try {
                  if (response.headers) {
                    ...
                    } else if (_typeof(response.headers) === 'object') {
                      // Only copy string values from headers
                ...
                try {
                  if (response.body) {
                    ...
                    } else if (_typeof(response.body) === 'object') {
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/interceptor/network-interceptor.js");
/******/ 	
/******/ })()
;
